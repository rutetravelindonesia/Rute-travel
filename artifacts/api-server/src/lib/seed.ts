...
export async function runMigrations(): Promise<void> {
  const migrations = [
    ...
    `ALTER TABLE rental_kendaraan ADD COLUMN IF NOT EXISTS tersedia_24jam BOOLEAN NOT NULL DEFAULT TRUE`,
    `ALTER TABLE rental_kendaraan ADD COLUMN IF NOT EXISTS jam_buka TEXT`,
    `ALTER TABLE rental_kendaraan ADD COLUMN IF NOT EXISTS jam_tutup TEXT`,
