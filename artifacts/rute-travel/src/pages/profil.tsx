...
const FAQ_PENUMPANG = [
  ...
  { q: "Apa itu Rental Kendaraan?", a: "Rental Kendaraan memungkinkan Anda menyewa kendaraan mitra per hari, baik lepas kunci (bawa sendiri) maupun dengan sopir." },
          ...
          {isDriver ? (
            <>
              ...
              <div>
                ...
                <p><strong className="text-foreground">7. Layanan Carter & Rental.</strong> Mitra yang menawarkan layanan carter bertanggung jawab memastikan kesiapan kendaraan dan ketersediaan pada tanggal dan jam yang disepakati. Mitra yang membuka Rental Kendaraan wajib memastikan kendaraan yang ditawarkan benar-benar tersedia dan dalam kondisi layak pada tanggal yang disepakati.</p>
              </div>
            ...
            <>
              ...
              <div>
                ...
                <p><strong className="text-foreground">7. Layanan Carter & Rental.</strong> Untuk layanan Carter, penumpang menyewa kendaraan secara penuh dengan waktu dan rute yang dapat dikustomisasi sesuai kesepakatan dengan mitra. Untuk Rental Kendaraan, penumpang menyewa kendaraan mitra per hari, baik lepas kunci (bawa sendiri) maupun dengan sopir sesuai ketersediaan mitra.</p>
              </div>
          ...
          {isDriver ? (
            <>
              <div>
                ...
                <p className="mb-2"><strong className="text-foreground">3. Data Operasional.</strong> Riwayat perjalanan (jadwal tetap, carter, rental), status perjalanan real-time, rekap penghasilan per periode, dan catatan pembatalan atau keluhan yang masuk.</p>
