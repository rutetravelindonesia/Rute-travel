...
export default function TebenganDetail() {
    ...
    <div className="min-h-screen bg-background max-w-md mx-auto flex flex-col">
      <div className="flex items-center gap-3 px-5 pt-10 pb-4 bg-card border-b border-border">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-muted-foreground">Detail perjalanan</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 py-16 text-center">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-6">
          Fitur Tebengan Pulang sedang dalam pengembangan. Segera tersedia untuk memberikan pilihan perjalanan lebih hemat.
        </p>
